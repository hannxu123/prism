...
## process the data
df = pd.read_csv('data_process/lending_300.csv') # 
...
for i in range(300):
        ...
        if info_df.iloc[0][tg_feature] == info_df.iloc[1][tg_feature]:
            ...
            while True:
                try:
                    ...
                    '- Give an estimation from 1 to 10 (1 = very unlikely to default, 10 = very likely to default).\n\n'
    ...
    with open("results/shap/shap_loan_gpt41_230to300.json", "w", encoding="utf-8") as f:
